 ...
 * as part of the {@link SessionInitResponseIMessage}. When
 * provided, the client will supply the token back to the server in the
 * {@link SessionInitIMessage} when reconnecting.
 * <p>
...
public abstract class TokenReconnectAuthenticationHandler
	 ...
	 * {@link AuthenticationHandler#checkConnection} but adds the {@code reconnect_token}
	 ...
	 * 				via the {@link IntrepidContext} class. It is
	 ...
	 *
	 * @param user_context      The context returned from {@code checkConnection}.
	 ...
	 *                          provided to {@code checkConnection}.
	 ...
	 *                          which was originally provided to {@code checkConnection}.
	 *
