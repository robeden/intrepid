...
//		assertEquals( server_instance.getLocalVMID(), pair.getTwo().get( 0 ) );
        assertInstanceOf(SessionInitIMessage.class, pair.getTwo().get(1));
...
//		assertEquals( client_instance.getLocalVMID(), pair.getTwo().get( 0 ) );
		...
		assertEquals(2, pair.getTwo().size());
		assertEquals(client_instance.getLocalVMID(), pair.getTwo().get( 0 ));
        assertInstanceOf(SessionInitResponseIMessage.class, pair.getTwo().get(1));
...
//		assertEquals( server_instance.getLocalVMID(), pair.getTwo().get( 0 ) );
		...
		assertEquals(2, pair.getTwo().size());
		assertEquals(server_instance.getLocalVMID(), pair.getTwo().get( 0 ));
        assertInstanceOf(InvokeIMessage.class, pair.getTwo().get(1));
		...
		assertEquals(2, pair.getTwo().size());
		assertEquals(client_instance.getLocalVMID(), pair.getTwo().get( 0 ));
        assertInstanceOf(InvokeReturnIMessage.class, pair.getTwo().get(1));
